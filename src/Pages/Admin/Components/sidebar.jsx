  ...
  return (
    <aside className="bg-blue-800 text-white h-full transition-all duration-300 w-20 lg:w-64 fixed">
      <div className="p-4">
        ...
        {user && user.permission && user.permission.includes("rencana-studi.page") && (
          <NavLink 
        ...
        {/* Modifikasi pada komponen Logout */}
        <Logout className="flex items-center space-x-2 px-4 py-2 rounded hover:bg-blue-700" />
      </div>
    </aside>
  );
};
